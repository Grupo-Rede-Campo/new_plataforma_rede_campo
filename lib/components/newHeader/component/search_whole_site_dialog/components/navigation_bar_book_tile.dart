...
class NavigationBarBookTile extends StatelessWidget {
  const NavigationBarBookTile({Key? key, required this.book}) : super(key: key);
          ...
          Flexible(
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Utils.launchUrlMethod(url: book.url!.trim());
                  },
                  child: const Text(
                    'Acesse aqui',
                    style: TextStyle(
