...
class ResearchProjectsScreen extends StatelessWidget {
  ResearchProjectsScreen({Key? key}) : super(key: key);

  ProjectStore projectStore = ProjectStore(projectType: ProjectType.PESQUISA);
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                const TitlePage(title: 'Projetos de pesquisa'),
                Observer(
                  builder: (context) {
