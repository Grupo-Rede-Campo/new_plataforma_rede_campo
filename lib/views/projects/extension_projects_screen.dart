...
import 'package:plataforma_rede_campo/views/projects/components/project_tile.dart';
...
class ExtensionProjectsScreen extends StatelessWidget {
  ExtensionProjectsScreen({Key? key}) : super(key: key);

  ProjectStore projectStore = ProjectStore(projectType: ProjectType.EXTENSAO);
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                const TitlePage(title: 'Projetos de extensão'),
                Observer(
                  builder: (context) {
