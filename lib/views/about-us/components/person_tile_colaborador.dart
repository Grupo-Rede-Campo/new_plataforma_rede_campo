...
class PersonTileColaborador extends StatelessWidget {
  PersonTileColaborador(
      {Key? key, required this.aboutStore, required this.index})
      : super(key: key);
        ...
        onTap: () {
          showDialog(
            ...
            builder: (context) => AlertDialogUser(
              peopleToDisplay: aboutStore.colaboradoresList[index],
            ),
          );
        },
        child: Column(
          ...
          children: [
            aboutStore.colaboradoresList[index].image.url != null
                ? ClipOval(
                    ...
                    child: SizedBox.fromSize(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: aboutStore.colaboradoresList[index].image.url,
                        fit: BoxFit.cover,
            ...
            Text(
              aboutStore.colaboradoresList[index].name,
