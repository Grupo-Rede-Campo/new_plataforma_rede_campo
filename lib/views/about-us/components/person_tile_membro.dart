...
class PersonTileMembro extends StatelessWidget {
  PersonTileMembro({Key? key, required this.aboutStore, required this.index})
      : super(key: key);
        ...
        onTap: () {
          showDialog(
            ...
            builder: (context) => AlertDialogUser(
              peopleToDisplay: aboutStore.membrosList[index],
            ),
          );
        },
        child: Column(
          ...
          children: [
            aboutStore.membrosList[index].image.url != null
                ? ClipOval(
                    ...
                    child: SizedBox.fromSize(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: aboutStore.membrosList[index].image.url,
                        fit: BoxFit.cover,
            ...
            Text(
              aboutStore.membrosList[index].name,
